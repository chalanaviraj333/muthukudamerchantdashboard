  ...
  (self["webpackChunktapsynewdashboard"] = self["webpackChunktapsynewdashboard"] || []).push([["src_app_carremote_allremotes_allremotes_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AllremotesPageRoutingModule": function AllremotesPageRoutingModule() {
          return (
            /* binding */
            _AllremotesPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _allremotes_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./allremotes.page */
      69352);
      ...
      var _AllremotesPageRoutingModule = function AllremotesPageRoutingModule() {
        _classCallCheck(this, AllremotesPageRoutingModule);
      };

      _AllremotesPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AllremotesPageModule": function AllremotesPageModule() {
          return (
            /* binding */
            _AllremotesPageModule
          );
        }
        /* harmony export */
      ...
      var _allremotes_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./allremotes-routing.module */
      46322);
      /* harmony import */


      var _allremotes_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./allremotes.page */
      69352);

      var _AllremotesPageModule = function AllremotesPageModule() {
        _classCallCheck(this, AllremotesPageModule);
      };

      _AllremotesPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _allremotes_routing_module__WEBPACK_IMPORTED_MODULE_0__.AllremotesPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AllremotesPage": function AllremotesPage() {
          return (
            /* binding */
            _AllremotesPage
          );
      ...
      var _raw_loader_allremotes_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./allremotes.page.html */
      14531);
      /* harmony import */


      var _allremotes_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./allremotes.page.scss */
      97611);
      /* harmony import */
      ...
      var _AllremotesPage = /*#__PURE__*/function () {
        function AllremotesPage(router, http, navParamService) {
          _classCallCheck(this, AllremotesPage);
        ...
        _createClass(AllremotesPage, [{
            ...
            this.http.get("https://tapsystock-a6450-default-rtdb.firebaseio.com/remotes.json").subscribe(function (resData) {
              for (var key in resData) {
                if (resData.hasOwnProperty(key)) {
                  ...
                  _this.remotes.sort(function (a, b) {
                    return a.boxnumber > b.boxnumber ? 1 : -1;
                  });
                }
              }
            });
          ...
          value: function ionViewWillEnter() {
            var changedLowStockItem = this.navParamService.getRemoteKey();

            if (changedLowStockItem !== undefined) {
              var changingitem = this.remotes.find(function (i) {
                return i.key === changedLowStockItem;
              });
          ...
          value: function _ionChange(event) {
            ...
            if (val && val.trim() != "") {
              this.searchedItem = this.searchedItem.filter(function (currentremote) {
                if (currentremote.compitablebrands !== undefined) {
                  var searchWord = currentremote.tapsycode + currentremote.inbuildblade + currentremote.compitablebrands.toString();
                  return searchWord.toLowerCase().indexOf(val.toLowerCase()) > -1;
                } else {
                  var _searchWord = currentremote.tapsycode + currentremote.inbuildblade;

                  return _searchWord.toLowerCase().indexOf(val.toLowerCase()) > -1;
                }
              });
            }
          }
          ...
          key: "onClick",
          value: function onClick(x) {
            var selectedremote = x;
        ...
        return AllremotesPage;
      }();

      _AllremotesPage.ctorParameters = function () {
        return [{
      ...
      _AllremotesPage.propDecorators = {
        search: [{
      ...
      _AllremotesPage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
...
//# sourceMappingURL=src_app_carremote_allremotes_allremotes_module_ts-es5.js.map